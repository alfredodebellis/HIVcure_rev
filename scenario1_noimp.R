...
incidence_undiag_nocure_time <- array(0,dim=c(len_post,nt))
...
for(i in 1:len_post){
  ...
  incidence_undiag_nocure_time[i,] <- incidence_undiag
...
save.image(paste0("RESULTS/SCENARIOS/SC1_eff", round(parms["eff"]*100,0),"_cu", round(ar*100,0), "_hc", hcfile,"_curestart",y_cure,"_noimp.RData"))
