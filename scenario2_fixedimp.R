...
load("RESULTS/fit_threshold15_fixedimp.RData")
...
save.image(paste0("RESULTS/SCENARIOS/SC2_eff", round(parms["eff"]*100,0), "_hc", hcfile,"_curestart",y_cure,"_fixedimp.RData"))
