...
> De Bellis, A., Willemsen, M., Guzzetta, G., van Sighem, A., Romijnders, K.A.G.J., Reiss, P., Schim van der Loeff, M.S., van de Wijgert, J.H.H.M., Nijhuis, M., Kretzschmar, M., & Rozhnova, G. (2024). Model-based evaluation of the impact of a potential HIV cure on HIV transmission dynamics.

This repository is linked to Zenodo and can be cited using the following DOI: 10.5281/zenodo.15031608
...
## Funding  
The authors gratefully acknowledge funding by the Aidsfonds Netherlands, grant number P-53902, awarded to G.R., and funding by Aidsfonds \& NWO, the SPIRAL project KICH2.V4P.AF23.001, awarded to G.R. and M.N. The survey data collection was funded by the Aidsfonds Netherlands, grant number P-52901, awarded to G.R.
